...
void StartScatteredTask(void const * argument)
{
  ...
  DISplay_ShowString(0,1,"des:",12);                              //�ַ���ʾ
  DISplay_ShowString(0,2,"dirBASE:",12);                          //�ַ���ʾ
  DISplay_ShowString(0,3,"dirADJUST:",12);                        //�ַ���ʾ
  DISplay_ShowString(0,4,"encoder:",12);                          //�ַ���ʾ
  /* Infinite loop */
  for(;;)
  { 
    DISplay_ShowFolatNum(80,0,att.rol,5,12);                      //����Ƕ�rol��ʾ
    DISplay_ShowFolatNum(80,1,Mpu.deg_s.y,5,12);                  //y����ٶ���ʾ
    DISplay_ShowFolatNum(80,2,dirBASE,5,12);                      //��������ֵ
    DISplay_ShowFolatNum(80,3,dirADJUST,5,12);                    //�������΢��ֵ
