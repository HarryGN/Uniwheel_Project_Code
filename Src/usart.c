 ...
 * ��������pu8printf
 * ����  �����ڴ�ӡ����
 * ����  ��name�ַ����ı���, pbuf����ӡ���� , count������ ��Mode��ʾģʽ
 * ����  ��
 */    
...
//	while(__HAL_DMA_GET_COUNTER(&hdma_usart1_tx));  //���DMA����ͨ���ڻ���û������
	if(Sendbuff)
	{
...
void Usart_RecvData(void)
{
  ...
  { 
    ANO_DT_Data_Receive_Anl(Usart1_Str.Usart_RecvBuff , Usart1_Str.Usart_RecvLens);   //�������ݽ���
    memset (Usart1_Str.Usart_RecvBuff , 0,Usart1_Str.Usart_RecvLens);                 //�����������
    Usart1_Str.Usart_RecvLens = 0;                                                    //���յ����ݳ������
    Usart1_Str.RecvFlags = 0;                                                         //��־λ���
  }
}
